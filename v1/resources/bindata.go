...
var _docsInterpolatorsClosestMd = []byte(`Woot!
...
func docsInterpolatorsClosestMdBytes() ([]byte, error) {
	return _docsInterpolatorsClosestMd, nil
}

func docsInterpolatorsClosestMd() (*asset, error) {
	bytes, err := docsInterpolatorsClosestMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/interpolators/closest.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _docsTransformsBottomMd = []byte(`The ` + "`" + `bottom` + "`" + ` transform is an equivalent of the ` + "`" + `top` + "`" + ` transform, 
but it returns the bottom-most elements. See the ` + "`" + `top` + "`" + ` transform for further documentation.`)

func docsTransformsBottomMdBytes() ([]byte, error) {
	return _docsTransformsBottomMd, nil
}

func docsTransformsBottomMd() (*asset, error) {
	bytes, err := docsTransformsBottomMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/bottom.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsIfMdBytes() ([]byte, error) {
	return _docsTransformsIfMd, nil
}

func docsTransformsIfMd() (*asset, error) {
	bytes, err := docsTransformsIfMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/if.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsIfelseMdBytes() ([]byte, error) {
	return _docsTransformsIfelseMd, nil
}

func docsTransformsIfelseMd() (*asset, error) {
	bytes, err := docsTransformsIfelseMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/ifelse.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsNextMd() (*asset, error) {
	bytes, err := docsTransformsNextMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/next.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsPrevMdBytes() ([]byte, error) {
	return _docsTransformsPrevMd, nil
}

func docsTransformsPrevMd() (*asset, error) {
	bytes, err := docsTransformsPrevMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/prev.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsRememberMd() (*asset, error) {
	bytes, err := docsTransformsRememberMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/remember.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _docsTransformsSentimentMd = []byte(`Sentiment is a very basic assesment of a text's sentiment from -1 to 1. It uses the [AFINN-111](http://www2.imm.dtu.dk/pubdb/views/publication_details.php?id=6010) wordlist,
...
func docsTransformsSentimentMdBytes() ([]byte, error) {
	return _docsTransformsSentimentMd, nil
}

func docsTransformsSentimentMd() (*asset, error) {
	bytes, err := docsTransformsSentimentMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/sentiment.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func docsTransformsSetMd() (*asset, error) {
	bytes, err := docsTransformsSetMdBytes()
	if err != nil {
		return nil, err
	}
...
func docsTransformsTopMdBytes() ([]byte, error) {
	return _docsTransformsTopMd, nil
}

func docsTransformsTopMd() (*asset, error) {
	bytes, err := docsTransformsTopMdBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "docs/transforms/top.md", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"data": &bintree{nil, map[string]*bintree{
		"AFINN.json": &bintree{dataAfinnJson, map[string]*bintree{}},
	}},
	"docs": &bintree{nil, map[string]*bintree{
		"interpolators": &bintree{nil, map[string]*bintree{
			"closest.md": &bintree{docsInterpolatorsClosestMd, map[string]*bintree{}},
		}},
